...
flags.DEFINE_string("dataset", "anime", "The name of dataset [anime, mnist, lsun]")
...
def main():
	...
	if not os.path.exist(FLAGS.checkpoint_dir):
		os.makedirs(FLAGS.checkpoint_dir)
	if not os.path.exist(FLAGS.sample_dir):
